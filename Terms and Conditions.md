...
Welcome to StreamHub ("the App", "we", "us", or "our"). These Terms of Use ("Terms") govern your access to and use of the StreamHub mobile and web application. By downloading, accessing, or using the App, you agree to be bound by these Terms. If you do not agree, please do not use the App.

## 1. Description of Service

StreamHub is a live TV and radio streaming application that aggregates and displays broadcast content using the DVB-I (Digital Video Broadcasting - Internet) standard. The App provides channel listings, an electronic program guide (EPG), live streaming playback (HLS/DASH), and related features.

StreamHub does not create, own, or host the broadcast content made available through the App. All channel streams, logos, and program metadata are provided by third-party broadcasters and content providers.
...
You may permanently delete your account and associated data at any time through the in-app account deletion feature. Deletion is irreversible.

## 4. Acceptable Use

You agree not to:
- Use the App for any unlawful purpose or in violation of these Terms
- Attempt to circumvent DRM, age restrictions, or content protection mechanisms
- Reverse engineer, decompile, or extract source code from the App, except as permitted by open-source licenses (if applicable)
- Use automated systems (bots, scrapers) to access the App without authorization
- Redistribute, re-broadcast, or resell streamed content

## 5. Third-Party Content and Services

- **Broadcast Content**: Channels, EPG data, and logos are sourced from third-party broadcasters via DVB-I metadata. We do not guarantee the accuracy, availability, or continuity of any channel or program.
- **Third-Party Services**: The App uses third-party infrastructure, including Supabase (authentication, data storage) and content delivery networks for video playback. Your use of the App is also subject to the applicable terms of these providers where relevant.
